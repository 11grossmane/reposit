...
var writeFile = util.promisify(fs_1.default.writeFile);
var readFile = util.promisify(fs_1.default.readFile);
var key = node_machine_id_1.machineIdSync();
var cryptr = new Cryptr(key);
exports.clearCache = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, writeFile(types_1.DATAPATH, "")];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.removeFromCache = function (provider) { return __awaiter(void 0, void 0, void 0, function () {
    var oldCredentials, newEncryptedCredentials, yamlString;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.checkCache(false)];
            case 1:
                oldCredentials = _a.sent();
                newEncryptedCredentials = oldCredentials;
                delete newEncryptedCredentials[provider];
                yamlString = js_yaml_1.default.safeDump(newEncryptedCredentials);
                return [4 /*yield*/, writeFile(types_1.DATAPATH, yamlString)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
exports.checkCache = function (decrypt) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var str, credentials, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, readFile(types_1.DATAPATH, { encoding: "utf8" })];
                case 1:
                    str = _a.sent();
                    credentials = js_yaml_1.default.safeLoad(str);
                    if (!decrypt)
                        return [2 /*return*/, credentials];
                    return [2 /*return*/, exports.decryptCredentials(credentials)];
                case 2:
                    e_1 = _a.sent();
...
exports.writeToCache = function (newCredentials) { return __awaiter(void 0, void 0, void 0, function () {
    var oldCredentials, oldEncryptedCredentials, newEncryptedCredentials, yamlString_1, yamlString;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exports.checkCache()];
            case 1:
                oldCredentials = _a.sent();
                oldEncryptedCredentials = exports.encryptCredentials(oldCredentials);
                newEncryptedCredentials = exports.encryptCredentials(newCredentials);
                if (!oldCredentials) return [3 /*break*/, 3];
                yamlString_1 = js_yaml_1.default.safeDump(__assign(__assign({}, oldEncryptedCredentials), newEncryptedCredentials), {
                    noRefs: true,
                });
                return [4 /*yield*/, writeFile(types_1.DATAPATH, yamlString_1)];
            case 2:
                _a.sent();
                return [2 /*return*/];
            case 3:
...
exports.validateCredentials = function (credentials, provider) { return __awaiter(void 0, void 0, void 0, function () {
    var creds, url, res, e_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                url = "";
                if (!(provider === types_1.Provider.BITBUCKET)) return [3 /*break*/, 2];
            ...
            case 1:
                ...
                return [3 /*break*/, 5];
            case 2:
                if (!(provider === types_1.Provider.GITHUB)) return [3 /*break*/, 5];
                shelljs_1.default.exec("open  'https://github.com/login/oauth/authorize?scope=user+repo+delete_repo&client_id=" + clientID + "'");
                _a.label = 3;
            case 3:
                if (!!(creds === null || creds === void 0 ? void 0 : creds.Github)) return [3 /*break*/, 5];
                return [4 /*yield*/, exports.checkCache()];
            case 4:
                creds = _a.sent();
                return [3 /*break*/, 3];
            case 5: return [2 /*return*/, creds];
            case 6:
                e_3 = _a.sent();
                console.log(e_3);
                console.log("error status is ", e_3.response.status);
                throw e_3;
...
exports.bitbucketCreate = function (credentials, repoName) { return __awaiter(void 0, void 0, void 0, function () {
    var slugifiedRepoName, _a, data, status_1, e_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
