...
var cli = function (internalArgs) { return __awaiter(void 0, void 0, void 0, function () {
    var provider, reset, credentials, repoName, answers, answers, res, e_1, e_2;
    var _a;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                if (!!util_1.hasCredentials(credentials, provider, reset)) return [3 /*break*/, 2];
            ...
            case 7:
                ...
                else if (e_1.response.status === 400) {
