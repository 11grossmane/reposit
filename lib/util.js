...
exports.writeToCache = function (newCredentials) {
    ...
    if (oldCredentials) {
        var yamlString_1 = js_yaml_1.default.safeDump(__assign(__assign({}, oldCredentials), newCredentials), {
            noRefs: true
        });
        fs_1.default.writeFileSync(types_1.DATAPATH, yamlString_1);
        return;
    }
    var yamlString = js_yaml_1.default.safeDump(newCredentials);
...
exports.validateCredentials = function (credentials, provider) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_1 = _a.sent();
                console.log('error status is ', e_1.response.status);
                throw e_1;
...
exports.bitbucketCreate = function (credentials, repoName) { return __awaiter(void 0, void 0, void 0, function () {
    var slugifiedRepoName, _a, data, status_1, e_2;
...
exports.githubDelete = function (credentials, repoName) { return __awaiter(void 0, void 0, void 0, function () {
    var url, status_3, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                url = types_2.GITHUB_DELETE_URL(credentials.username, repoName);
