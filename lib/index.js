...
exports.cli = function (internalArgs) { return __awaiter(void 0, void 0, void 0, function () {
    var provider, reset, credentials, loginAnswers, e_1, storeAnswer, repoName, _a, answers, response, e_2, response, e_3, res, e_4, e_5;
    var _b;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                if (!!util_1.hasCredentials(credentials, provider, reset)) return [3 /*break*/, 11];
            ...
            case 8:
                ...
                return [2 /*return*/];
            case 9: return [4 /*yield*/, questions_1.storeQuestion()];
            case 10:
                storeAnswer = _d.sent();
            ...
            case 15:
                ...
                if (!commander_1.default.delete) return [3 /*break*/, 27];
                return [4 /*yield*/, questions_1.deleteQuestions(provider, repoName)];
            case 16:
                answers = _d.sent();
                if (!(answers.delete && provider === types_1.Provider.GITHUB && (credentials === null || credentials === void 0 ? void 0 : credentials.Github))) return [3 /*break*/, 21];
                _d.label = 17;
            case 17:
            ...
            case 21:
                if (!(answers.delete && provider == types_1.Provider.BITBUCKET && (credentials === null || credentials === void 0 ? void 0 : credentials.Bitbucket))) return [3 /*break*/, 26];
                _d.label = 22;
            case 22:
            ...
            case 27:
                ...
                if (!(provider == types_1.Provider.BITBUCKET && credentials.Bitbucket)) return [3 /*break*/, 32];
                _d.label = 28;
            case 28:
            ...
            case 32:
                if (!(provider == types_1.Provider.GITHUB && credentials.Github)) return [3 /*break*/, 36];
                _d.label = 33;
            case 33:
                _d.trys.push([33, 35, , 36]);
