...
exports.checkCache = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                url = "";
                if (provider === types_1.Provider.BITBUCKET) {
                    url = types_1.BITBUCKET_LOGIN_URL;
                }
                else if (provider === types_1.Provider.GITHUB) {
                    url = types_1.GITHUB_LOGIN_URL;
                }
                return [4 /*yield*/, axios_1.default.get("https://api.github.com/user/" + credentials.username)];
            case 1:
                res = _a.sent();
                return [3 /*break*/, 3];
            case 2:
